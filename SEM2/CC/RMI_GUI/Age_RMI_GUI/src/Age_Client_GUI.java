...
public class Age_Client_GUI extends javax.swing.JFrame {

    public Age_Client_GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Age Calculator RMI");
        jLabel2.setText("Enter Birth Year :");
        jLabel3.setText("Enter Birth Month :");
        jLabel4.setText("Enter Birth Day :");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Age_Client_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Age_Client_GUI().setVisible(true);
            }
        });
    }
